      ...
      <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm mb-8 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row gap-4 justify-between items-center pt-2 border-t border-slate-50">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end">
            {/* Botão Novo Material — destaque verde */}
            {onNewMaterial && (
              <button
                onClick={onNewMaterial}
                className="h-10 px-5 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold flex items-center gap-2 shadow-sm shadow-emerald-200 transition-all hover:shadow-md hover:scale-105"
              >
