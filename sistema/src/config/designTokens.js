...
// Compatibilidade CommonJS para uso nas Cloud Functions (Node.js)
// As Cloud Functions rodam em CJS; este bloco permite:
//   const { materialTypes } = require("../sistema/src/config/designTokens");
if (typeof module !== "undefined" && module.exports) {
  module.exports = { designTokens, materialTypes, categories };
}
