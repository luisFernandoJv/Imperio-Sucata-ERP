...
export function useUpdateTransaction() {
  ...
  return useMutation({
    ...
    onMutate: async ({ id, data }) => {
      ...
      queryClient.setQueryData(QUERY_KEYS.transactions, (old) => old?.map((t) => (t.id === id ? { ...t, ...data } : t)))
...
export function useDeleteTransaction() {
  ...
  return useMutation({
    ...
    onMutate: async (id) => {
      ...
      queryClient.setQueryData(QUERY_KEYS.transactions, (old) => old?.filter((t) => t.id !== id))
