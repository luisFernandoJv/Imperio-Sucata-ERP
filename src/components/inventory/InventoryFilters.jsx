...
import { Search, LayoutGrid, List, AlertTriangle, Download, Printer } from "lucide-react"
    ...
    <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm mb-8 space-y-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4 justify-between items-center pt-2 border-t border-slate-50">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end">
          ...
          <button onClick={onPrint} className="h-10 px-4 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-slate-900 text-sm font-bold flex items-center gap-2 transition-colors">
            <Printer className="h-4 w-4" /> Imprimir
          </button>
          
          <button onClick={onExport} className="h-10 px-4 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-slate-900 text-sm font-bold flex items-center gap-2 transition-colors">
