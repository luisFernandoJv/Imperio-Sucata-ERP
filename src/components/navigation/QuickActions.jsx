  ...
  const actions = [
    {
      ...
      action: () => { onAction("transaction", "venda"); setIsOpen(false); },
    },
    {
      id: "nova-compra",
      label: "Nova Compra",
      ...
      action: () => { onAction("transaction", "compra"); setIsOpen(false); },
    },
    {
      id: "nova-despesa",
      label: "Nova Despesa",
      ...
      action: () => { onAction("expenses"); setIsOpen(false); },
    },
    {
      id: "calculadora",
      label: "Calculadora",
      ...
      action: () => { console.log("Open calculator"); setIsOpen(false); },
    },
  ]
